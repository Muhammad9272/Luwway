<li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
            ...
            <li>
             ...
             <li>
                <a href="{{ route('admin-gs-announcement') }}"><span>{{ __('Announcement') }}</span></a>
            </li>
            <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-sb-index') }}"><span>{{ __('Top Banners') }}</span></a>
            </li>

            <li>
                <a href="{{ route('admin-sb-large') }}"><span>{{ __('Mid Banners') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-sb-bottom') }}"><span>{{ __('Bottom Banners') }}</span></a>
            </li>

            <li>
                <a href="{{ route('admin-review-index') }}"><span>{{ __('Home page 3 cards') }}</span></a>
            </li>
            <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="payments" data-parent="#accordion">
            <li><a href="{{route('admin-gs-payments')}}"><span>{{__('Payment Information')}}</span></a></li>
             <li><a href="{{route('admin-tax-index')}}"><span>{{ __('Region Wise Tax') }}</span></a></li>
