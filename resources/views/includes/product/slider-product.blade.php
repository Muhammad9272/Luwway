                       ...
                       {{--  @if($feature_product->user_id==0)
                        ...
                        @else
                          <div class="row">
                            ...
                            <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 awaaly-vendor-shop" >
                              <span>
                                 <a class="ps-product__vendor mob-ps-product__vendor mob-ps-product__vendor-font" href="{{ route('front.vendor',$feature_product->user->shop_name) }}"> {{$feature_product->user->shop_name}}</a>
                              </span>                     
                            </div>
                          </div>    
                        @endif --}}
                        ...
                        <div class="ps-block__content" >
                          ...
                          <p class="ps-product__price">
                            <span class="ps-product__pricee">
                              {{$feature_product->showPrice($gs,$curr)}} &nbsp; <span class="ps-product__priceee">
                              {{$feature_product->showPreviousPrice($gs,$curr)}}</span> 
                              @if($feature_product->showPreviousPrice($gs,$curr))
                              <span class="ps-product__pricee1">
                                @php 
                                  $discount=( $feature_product->showPrice($gs,$curr,$op)/$feature_product->showPreviousPrice($gs,$curr,$op) )*100;
