            <div class="col-lg-8">
                <form id="" action="javascript:;" method="POST" class="checkoutform">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="billing-address">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <select class="form-control checkout_region" id="checkout_country"
                                                     name="customer_country" required="">
                                                        @include('includes.checkout.countries')
                                                    </select>
                                                </div>

                                                <div class="col-lg-6">
                                                    <select class="form-control checkout_region" id="state" name="customer_state" required="">
                                                       <option value="">{{ __('Select State') }}</option>
                                                       @if(isset($states))
                                                        @include('includes.checkout.states')
                                                       @endif
                                                    </select>
                                                </div>
                    ...
                    <input type="hidden" name="tax" id="tax" value="{{isset($tax_region)?$tax_region:$gs->tax}}">
                    ...
                    <input type="hidden" id="prodtotal" value="{{Session::get('cart')->totalPrice}}">
            ...
            <div class="col-lg-4">
                <div class="right-area">
                    ...
                    <h4 class="title">Cart Summary{{-- {{ $langg->lang127 }} --}}</h4>
                           @if(count($products) <= 1)
                        ...
                        <div class="d-flex mb-20">                                         
                            @foreach($products as $product)                                                                                                        
                            <div class="ps-product--cartmm ">
                                <div class="ps-product__thumbnail"><a href="{{ route('front.product', $product['item']['slug']) }}">
                                    <img src="{{asset('assets/images/products/'.$product['item']['photo'])}}" alt=""></a>
                                </div>
                            </div>                                                                                      
                            @endforeach   
                        </div>  
                    ...
                    <ul class="order-list">
                        ...
                        <P>
                            <b id="rgtax"> {{isset($tax_amount)?$tax_amount:0}}</b>
