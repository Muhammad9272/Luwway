...
<hr>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Paypal Client ID') }}" name="paypal_client" value="{{ $gs->paypal_client }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Paypal Secret ID') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Paypal Secret') }}" name="paypal_secret" value="{{ $gs->paypal_secret }}" required="">
                          </div>
                        </div>                        
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Paypal Live') }} *
                                  </h4>
                            </div>
                          </div>
                          ...
                          <div class="col-lg-6">
                            <label class="switch">
                              <input type="checkbox" name="paypal_live" value="1" {{ $gs->paypal_live == 1 ? "checked":"" }}>
                        ...
                        <h4 class="text-center">{{ __('Withdraw Charges') }}</h4>
                        <hr>
                         <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Fixed Price') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Fixed Price') }}" name="withdraw_fixedprice" value="{{ $gs->withdraw_fixedprice }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Comission Fee(%) ') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Comission Fee(%)') }}" name="withdraw_fee" value="{{ $gs->withdraw_fee }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Processing fee(%)') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Processing fee(%)') }}" name="withdraw_charge" value="{{ $gs->withdraw_charge }}" required="">
                          </div>
                        </div>

                      <hr>

                        <h4 class="text-center">{{ __('Product Shipping tax') }}</h4>
                          ...
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Tax(%)') }} *
                                   ...
                                   <p class="sub-heading">{{ __("By Default(In case if specific region tax not found)") }}</p>
                            </div>
                          </div>
                          <div class="col-lg-6">
