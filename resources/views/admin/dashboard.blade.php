...
<style type="text/css">
    .row-cards-one .mycard.bg7 {
            background-image: linear-gradient(to right, #000000, #b3a896);
    }
    .row-cards-one .mycard.bg7::after{
            background: #503f37;
    }
    .row-cards-one .mycard.bg8 {
            background-image: linear-gradient(to right, #242667, #1ed41e);
    }
    .row-cards-one .mycard.bg8::after{
            background: #e4ac14;
    }
</style>
@section('content')
    ...
    <div class="row row-cards-one">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg7">
                <div class="left">
                    ...
                    <span class="number">{{ App\Models\Product::convertPrice( App\Models\Order::where( 'created_at', '>', Carbon\Carbon::now()->subDays(30))->sum('pay_amount') ) }}
                    </span>
                    <p class="link" style="width: 90px">{{ __('Last 30 days') }}</p>
                </div>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg8">
                <div class="left">
                    <h5 class="title">Total Earnings!</h5>
                    <span class="number">{{ App\Models\Product::convertPrice( App\Models\Order::all()->sum('pay_amount') ) }}</span>
                    <p class="link">{{ __('All Time') }}</p>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                       <i class="icofont-dollar-true"></i>
