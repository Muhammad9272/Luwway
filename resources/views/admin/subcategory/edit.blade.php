                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-subcat-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Mega menu image') }} *</h4>
                                <p class="sub-heading">{{ __('(Preferred size 276 * 359)') }}</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <div class="img-upload">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->mega_image ? asset('assets/images/categories/'.$data->mega_image):asset('assets/images/noimage.png') }});">
                                    <label for="image-upload" class="img-label" id="image-label"><i class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                    <input type="file" name="mega_image" class="img-upload" id="image-upload">
                                  </div>
                            </div>
