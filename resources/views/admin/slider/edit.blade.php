               ...
               <div class="body-area">
                  ...
                  <form id="geniusform" action="{{route('admin-sl-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="row">
                        <div class="col-lg-4">
                           <div class="left-area">
                              <h4 class="heading">{{ __('Current Featured Image') }} *
                                 <p class="text">{{ __('If internet connection is slow this image will be loaded first') }}</p>
                              </h4>
                           </div>
                        </div>
                        <div class="col-lg-7">
                     ...
                     <div class="row">
                        <div class="col-lg-4">
                           <div class="left-area">
                              <h4 class="heading">{{ __('Current Video') }} *
                                 <p class="text">{{ __('Upload it in mp4 format') }}</p>
                              </h4>
                           </div>
                        </div>
                        <div class="col-lg-7">
                           <div class="img-upload full-width-img">
                              <div class="currrent-logo">
                                <video width="320" height="240" controls>
                                   <source src="movie.mp4" type="{{ $data->video ? asset('assets/images/sliders/'.$data->video):asset('assets/images/noimage.png')}}">
                                   <source src="movie.ogg" type="{{ $data->video ? asset('assets/images/sliders/'.$data->video):asset('assets/images/noimage.png')}}">
