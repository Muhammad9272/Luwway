										...
										<div class="table-responsiv">
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
															<th>
																<label style="margin-bottom: 0px;"><input type="checkbox" id="master">&nbsp;&nbsp;Select All</label>
															</th>
									                        <th>{{ __("Name") }}</th>
									                        <th>{{ __("Email") }}</th>
									                        <th>{{ __("Options") }}</th>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		$(function() {
        $(".btn-area").append('<div class="col-sm-6 table-contents" style="text-align:left">'+
        	'<a class="add-btn drop-danger " data-href="{{route('admin-user-removeall')}}" id="delete_all" >'+
          '<i class="fas fa-trash"></i> {{ __('Delete Selected items') }}'+
          '</a>'+
          '</div>');
      });		
