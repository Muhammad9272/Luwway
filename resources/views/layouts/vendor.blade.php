         ...
         <div class="header">
            <div class="container-fluid">
               <div class="d-flex justify-content-between">
                  <div class="menu-toggle-button" style="display: none">
                  ...
                  <div class="center center-con">
                     Hello ,{{Auth::user()->name}}

                  </div>

                  <div class="right-eliment d-inline-flex">

                     <div class="d-inline-flex left-alignm left-alignm-mob">
                        <div class="avil">
                           <p><strong>Available For Deposit : {{ App\Models\Product::vendorConvertPrice(Auth::user()->current_balance) }}</strong></p>
                        </div>
                        <div class="visit">
                           <div class="visit-storee"><i class="fas fa-eye"></i></div>
         ...
         <div class="wrapper">
            ...
            <nav id="sidebar" class="nav-sidebar">
               <ul class="list-unstyled components" id="accordion">
                  ...
                  <li>
                     <a class="wave-effect" href="{{route('vendor-reports')}}">

                     <i class="fa fa-bar-chart" aria-hidden="true"></i>Reports</a>
                  </li>
                  ...
                  <li>
                     @if(!Auth::user()->VendorSchedule)
                     <a href="{{ route('vendor-store-Schedule') }}" class=" wave-effect"><i class="fas fa-clock"></i>{{ __('Add Store Hours') }}</a>
                     @else
                     <a href="{{ route('vendor-Schedule-edit') }}" class=" wave-effect"><i class="fas fa-clock"></i>{{ __('Edit Store Hours') }}</a>
                     @endif
                  </li>
                  <li>
                     <a href="{{ route('vendor-subpackage-index') }}" class=" wave-effect"><i class="fas fa-dollar-sign"></i>Pricing Plans</a>
                  </li>
                  <li>
                   ...
                   <li>
                    <a class=" wave-effect" href="{{ route('vendor-get-policy') }}">Shipping Policy</a>
                  </li>
