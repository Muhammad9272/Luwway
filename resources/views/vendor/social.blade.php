            ...
            <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
              ...
              @include('includes.admin.form-both')  
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input class="form-control" name="y_url" id="youtube" placeholder="{{ __('Youtube') }}" required="" type="text" value="{{$data->y_url}}">
                  </div>
                  <div class="col-sm-3">
                    <label class="switch">
                      <input type="checkbox" name="y_check" value="1" {{$data->y_check==1?"checked":""}}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
                ...
                <div class="row">
                  <label class="control-label col-sm-3" for="pinterest">{{ __('Pinterest') }}  *</label>
                  <div class="col-sm-6">
                    <input class="form-control" name="p_url" id="pinterest" placeholder="{{ __('Pinterest') }}" required="" type="text" value="{{$data->p_url}}">
                  </div>
                  <div class="col-sm-3">
                    <label class="switch">
                      <input type="checkbox" name="p_check" value="1" {{$data->p_check==1?"checked":""}}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input class="form-control" name="i_url" id="instagram" placeholder="{{ __('Instagram') }}" required="" type="text" value="{{$data->i_url}}">
                  </div>
                  <div class="col-sm-3">
                    <label class="switch">
