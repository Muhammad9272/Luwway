...
class GeneralSettingController extends Controller
{
    ...
    [
        ...
        'vendor_image'        => 'mimes:jpeg,jpg,png,svg',        
    ...
    public function generalupdate(Request $request)
    {
        ...
        $data = Generalsetting::findOrFail(1);
            ...
            if ($file = $request->file('vendor_image'))
            {
                $name = time().$file->getClientOriginalName();
                $data->upload($name,$file,$data->vendor_image);
                $input['vendor_image'] = $name;
            }
    ...
    {
        return view('admin.generalsetting.top_announcement');
    }
    ...
    public function isannouncement($status)
    {
        $data = Generalsetting::findOrFail(1);
        $data->announcement_check = $status;
        $data->update();
    }
    ...
    public function videoslider($status)
    {
        $data = Generalsetting::findOrFail(1);
        $data->is_video_slider = $status;
        $data->update();
    }
