...
class SubCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $input = $request->all();
                if ($file = $request->file('mega_image'))
         {
            $name = time().$file->getClientOriginalName();
            $file->move('assets/images/categories',$name);
            $input['mega_image'] = $name;
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        $input = $request->all();
                if ($file = $request->file('mega_image'))
            {
                $name = time().$file->getClientOriginalName();
                $file->move('assets/images/categories',$name);
                if($data->mega_menu != null)
                {
                    if (file_exists(public_path().'/assets/images/categories/'.$data->mega_image)) {
                        unlink(public_path().'/assets/images/categories/'.$data->mega_image);
                    }
                }
            $input['mega_image'] = $name;
            }
