        ...
        public function datatables()
        {
             ...
             return Datatables::of($datas)
                                ->addColumn('select', function(User $data) {
                                    return '<div class="action-list"><input type="checkbox" data-id="'.$data->id.'" class="sub_chk"></div>';
                                })
        ...
        public function removeall(Request $request)
        {
            ...
            foreach(explode(",",$ids) as $id){
                ...
                if($user->notivications->count() > 0)
                {
                    ...
                    //If Photo Exist
                    elseif (file_exists(public_path().'/assets/images/users/'.$user->photo)) {
                            unlink(public_path().'/assets/images/users/'.$user->photo);
                         }
              $user->delete();
              $count=$count+1;
