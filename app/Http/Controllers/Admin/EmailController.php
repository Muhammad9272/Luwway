...
class EmailController extends Controller
{
    ...
    {
         $datas = EmailTemplate::where('status',1)->orderBy('id','asc')->get();
         //--- Integrating This Collection Into Datatables
         return Datatables::of($datas)
                            ->addColumn('action', function(EmailTemplate $data) {
                                return '<div class="action-list"><a href="' . route('admin-mail-edit',$data->id) . '" class="edit" > <i class="fas fa-edit"></i>Edit</a></div>';
                            }) 
