...
class SliderController extends Controller
{
    ...
    {
         $datas = Slider::where('is_video','!=',1)->orderBy('id','desc')->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        if($data->id==14){
            ...
            {              
                ...
                if($data->video != null)
                {
                    if (file_exists(public_path().'/assets/images/sliders/'.$data->video)) {
                        unlink(public_path().'/assets/images/sliders/'.$data->video);
                    }
                }  
