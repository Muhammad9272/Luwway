    ...
    {    
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(Coupon $data) {
                                return '<div class="action-list"><a data-href="' . route('vendor-coupon-edit',$data->id) . '" class="edit" data-toggle="modal" data-target="#modal1"> <i class="fas fa-edit"></i>Edit</a><a href="javascript:;" data-href="' . route('vendor-coupon-delete',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
                            }) 
